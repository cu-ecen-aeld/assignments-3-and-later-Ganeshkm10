...
if [ ! -e ${OUTDIR}/linux-stable/arch/${ARCH}/boot/Image ]; then
    ...
    echo "Removing all intermediate files including .config file"
...
echo "Creating the skeleton directory structure in the root filesystem"
   mkdir rootfs
   cd rootfs
...
# TODO: Make device nodes
  ...
  echo "Creating console and null device nodes"
